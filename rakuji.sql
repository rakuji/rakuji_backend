...
(1111116, 'John', '114b64da3ee0913b15a967560d88ba8625758310.jpg', '2022-02-19', '2022-02-25', '94879487'),
(1111117, '8888', '', '2022-02-11', '2022-02-15', '212213');
...
(9, '2022-07-08 12:29:50', '', '彭依恬', 'D295331736', '女', '學生', '2008-07-20', '南投縣', '草屯鎮玉成路31號', '未婚', '無小孩', 'tian@gmail.com', '0947417130', 'tian'),
...
(35, '2022/06/14', NULL, '亞瑟王', NULL, '男', NULL, NULL, NULL, NULL, NULL, NULL, 'wang@gmail.com', '0987123456', 'wang'),
(36, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'jason@gmail.com', NULL, 'jason');
...
(268, 6, 5, 5, '有夠好吃~超讚的CP值', '2022-06-13 06:12:51'),
(269, 2, 5, 6, '超讚的出貨速度', '2022-06-13 08:22:38');
...
--
ALTER TABLE `booking`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT '訂位編號', AUTO_INCREMENT=159;
...
--
ALTER TABLE `latest_news`
  MODIFY `sid` int NOT NULL AUTO_INCREMENT COMMENT '最新消息編號', AUTO_INCREMENT=1111118;
...
--
ALTER TABLE `member`
  MODIFY `MID` int NOT NULL AUTO_INCREMENT COMMENT '會員編碼', AUTO_INCREMENT=37;
...
--
ALTER TABLE `order`
  MODIFY `sid` int NOT NULL AUTO_INCREMENT COMMENT '訂單編號', AUTO_INCREMENT=323;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `orderdetail`
--
ALTER TABLE `orderdetail`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT '編號', AUTO_INCREMENT=461;
...
--
ALTER TABLE `products_comment`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT '編號', AUTO_INCREMENT=272;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `recipesboxcooking`
--
ALTER TABLE `recipesboxcooking`
  MODIFY `RecipesBoxCooking1_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `recipesingredients`
--
ALTER TABLE `recipesingredients`
  MODIFY `RecipesIngredients_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
...
--
ALTER TABLE `recipesnutrient`
  MODIFY `RecipesNutrient_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `recipesseasoning`
--
ALTER TABLE `recipesseasoning`
  MODIFY `RecipesSeasoning_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
